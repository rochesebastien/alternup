<template>
  <div class="w-full px-6 py-10 space-y-6">
    <UButton variant="link" color="neutral" icon="i-lucide-arrow-left" to="/tuteur/projects" class="-ml-2 px-2 text-[var(--ui-text-muted)]">
      Retour aux projets
    </UButton>
          ...
          <UFormField label="Alternant ou stagiaire" name="studentId" required>
            ...
            <template #help>
              <span v-if="learnerItems.length === 0" class="text-xs text-amber-600">
                ...
                <NuxtLink to="/tuteur/alternants" class="underline">Ajouter d'abord un alternant</NuxtLink>.
              </span>
            </template>
          </UFormField>
