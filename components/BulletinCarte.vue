...
/**
 * Fiche d'un bulletin (consultation, signature, export PDF), partagée par
 * /tuteur/bulletins/carte/[id] et /alternant/bulletins/carte/[id] : le rendu
 * est identique quel que soit le rôle, seule la signature dépend de l'identité.
 */
