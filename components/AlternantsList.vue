            ...
            <div class="flex items-center space-x-4">
              <div class="flex-shrink-0">
                <div class="h-10 w-10 rounded-full bg-emerald-100 flex items-center justify-center">
                  <span class="text-emerald-600 font-medium">{{ getInitials(alternant.nom, alternant.prenom) }}</span>
                </div>
              </div>
              <div class="flex-1 min-w-0">
                ...
                <p v-if="alternant.email" class="text-xs text-gray-400 truncate mt-1">
                  {{ alternant.email }}
                </p>
              </div>
