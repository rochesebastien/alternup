...
/**
 * Détail d'un rapport d'étape, partagé par /tuteur/rapports/[id] et
 * /alternant/rapports/[id] : le gros du rendu est commun, les capacités
 * (édition par l'auteur, revue par le tuteur destinataire) sont des contrôles
 * d'identité — pas des branches de navigation par rôle.
 */
