...
// `/api/invitations/<token>` (GET) est consulté depuis /register par un
// visiteur non connecté : le token aléatoire sert de capacité d'accès. La
// création (`POST /api/invitations`, sans segment) reste protégée.
export const PUBLIC_API_PREFIXES = ['/api/_', '/api/invitations/'] as const
